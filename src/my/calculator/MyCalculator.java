...
public class MyCalculator {
    ...
    // Объявление и инициализируем компоненты окна. 
    ...
    JButton buttonUmnojenie=new JButton("*");
...
Плюс, Минус, Разделить и Умножить*/      
    ...
    p2.add(buttonPlus);       
    p2.add(buttonMinus);       
    p2.add(buttonUmnojenie);       
    p2.add(buttonDelenie);         

//Добавляем панель в правую часть окна
...
// регистрируем его в каждой кнопке 
    ...
    buttonUmnojenie.addActionListener(calcEngine);
